...
extension MTLComputeCommandEncoder
{
    ...
    public func setBuffer( _ buffer:MTLBuffer,  offset:Int=0, at idx:Int ) {
        self.setBuffer( buffer, offset: offset, index: idx )
    }
    public func setBuffer( _ buffer_base:CAIMMetalBufferBase, offset:Int=0, at idx:Int ) {
        self.setBuffer( buffer_base.metalBuffer, offset: offset, index: idx )
    }
    public func setBuffer( _ mem:CAIMMetalBufferAllocatable, offset:Int=0, at idx:Int ) {
        self.setBuffer( mem.metalBuffer, offset: offset, index: idx )
    }
    public func setBuffer<T>( _ shape:CAIMMetalShape<T>, at idx:Int ) {
