...
class CAIMMetalComputeEngine
{
    /*
    func compute(pl:CAIMMetalComputer, thread_size:Size2) {
        // 適用可能のスレッド数の計算
        ...
        let command_buffer:MTLCommandBuffer = CAIMMetal.commandQueue.makeCommandBuffer()!
